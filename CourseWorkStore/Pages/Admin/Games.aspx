<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Games.aspx.cs" 
    Inherits="CourseWorkStore.Pages.Admin.Games" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="CourseWorkStore.Models.Game" SelectMethod="GetGames"
        ...
        <InsertItemTemplate>
            <tr>
                ...
                <td>
                    <input name="price" /></td>
                <td>
                    <asp:Button ID="Button5" CommandName="Insert" Text="Добавить" runat="server" />
                </td>
            </tr>
        </InsertItemTemplate>
    </asp:ListView>
